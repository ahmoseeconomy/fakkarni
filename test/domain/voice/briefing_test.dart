...
void main() {
  ...
  test('كذا دوا: العدد وأول جرعة بكلام المرساة', () {
    ...
    expect(text, 'صباح الخير. النهارده عندك ٣ أدوية، أولها الساعة ٨:٠٠ الصبح بعد الفطار بنص ساعة.');
  });
  ...
  test('دوا واحد بساعة ثابتة: «معادها» ومن غير كلام مرساة', () {
    ...
    expect(text, 'مساء الخير. النهارده عندك دوا واحد، معادها الساعة ٩:٠٠ بالليل.');
  });
  ...
  test('ميعاد النهارده', () {
    ...
    expect(text, contains('النهارده عندك دواين، أولها الساعة ٨:٠٠ الصبح مع الفطار.'));
    expect(text, contains('وعندك ميعاد دكتور الساعة ١١:٠٠ الصبح.'));
  });
