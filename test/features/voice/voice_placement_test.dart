...
const placement = <String, Set<String>>{
    ...
    'gen_no_medical': {'features/health/vitals/vital_history.dart'},
    ...
    'gen_try_hands': {'features/medication/scan_package_screen.dart', 'features/scan/scan_prescription_screen.dart'},
    'gen_goodbye': {'features/voice/voice_settings_screen.dart'},
    'lis_intro': {'features/voice/listen_button.dart'},
    'lis_listening': {'features/voice/listen_flow.dart'},
    'lis_not_understood': {'features/voice/listen_flow.dart'},
    'lis_confirm': {'features/voice/listen_flow.dart'},
    'lis_mic_permission': {'features/voice/listen_flow.dart'},
    'lis_mic_denied': {'features/voice/listen_flow.dart'},
