...
class Medications extends Table with TableInfo {
  ...
  late final GeneratedColumn<int> notBoughtAt = GeneratedColumn<int>(
    'not_bought_at',
    aliasedName,
    true,
    type: DriftSqlType.int,
...
class MedicationStock extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  MedicationStock(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> uuid = GeneratedColumn<String>(
    'uuid',
    aliasedName,
    false,
  ...
  @override
  MedicationStock createAlias(String alias) {
    return MedicationStock(attachedDatabase, alias);
  }
...
class DatabaseAtV28 extends GeneratedDatabase {
  ...
  late final MedicationStock medicationStock = MedicationStock(this);
  @override
