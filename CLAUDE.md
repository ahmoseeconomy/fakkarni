...
**والاختبار ده نفسه عمره ما اشتغل.** اتكتب من غير محاكي هنا، فأول تشغيل
في CI هو أول مرة ينفّذ — ولو وقع، يبقى وقع في الاختبار مش بالضرورة في
التطبيق. اقرا التقرير قبل ما تصلّح حاجة في `lib/`.
