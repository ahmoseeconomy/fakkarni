...
اللي اتعمل: الاختبار بقى **يفتح الملف زي ما التطبيق بيفتحه (قراية
وكتابة)** — ده بيشيل سلبية كاذبة ومش بيضعّف التأكيد، لأن استرجاع الـWAL
بيظهر المعاملات المكتملة بس؛ وبقى **يستنّى لحد ما الصف يظهر ويقول خد
قد إيه** بدل ثابت مخمّن؛ وبقى **يطبع الدليل قبل ما يقع**: أحجام وتواريخ
`.sqlite` و`-wal` و`-shm`، والعدّ بالطريقتين جنب بعض، وآخر ٢٠٠ سطر
تخصّنا من اللوج.
