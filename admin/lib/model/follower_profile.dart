// **نسخة حرفية من `lib/domain/care/follower_profile.dart` في حزمة التطبيق.**
//
// لوحة الأدمن حزمة مستقلة وما بتستوردش `package:fakkarni/` أبداً
// (`test/no_mobile_import_test.dart`). تعديل هناك بيتنقل هنا بالإيد.
