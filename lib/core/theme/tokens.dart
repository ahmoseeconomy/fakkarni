...
abstract final class F {
  ...
  /// والأخضر وكل حاجة قريبة منهم، الباقي عايلتين بس — بنفسجي وبرونزي.
  /// عشان كده «جاية» و«زيارات» ولاد عم؛ الفرق بينهم متقاس (١٧٫٧ نهاري)،
  /// والعنوان المكتوب فوق كل قسم هو اللي بيحمل الهوية أصلاً.
  static Color get careAccentDue => gold;
  static Color get careAccentUpcoming =>
      _mode(const Color(0xFF4A2A86), const Color(0xFF9B6BC0));
  ...
  static Color get careAccentVisit =>
      _mode(const Color(0xFF9C5C8F), const Color(0xFFDB9ACE));
  static Color get careAccentLab =>
      _mode(const Color(0xFF573611), const Color(0xFFC76728));
