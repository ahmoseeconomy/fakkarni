...
class $RecordsTable extends Records with TableInfo<$RecordsTable, RecordRow> {
  ...
  static const VerificationMeta _checkupStageMeta = const VerificationMeta(
    'checkupStage',
  );
  @override
  ...
  static const VerificationMeta _fastingReminderAtMeta = const VerificationMeta(
    'fastingReminderAt',
  );
  @override
  late final GeneratedColumn<DateTime> fastingReminderAt =
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('checkup_stage')) {
      context.handle(
        _checkupStageMeta,
        checkupStage.isAcceptableOrUnknown(
          data['checkup_stage']!,
          _checkupStageMeta,
        ),
      );
    }
    if (data.containsKey('fasting_reminder_at')) {
      context.handle(
        _fastingReminderAtMeta,
        fastingReminderAt.isAcceptableOrUnknown(
          data['fasting_reminder_at']!,
          _fastingReminderAtMeta,
        ),
      );
    }
  ...
  RecordRow map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return RecordRow(
      ...
      checkupStage: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}checkup_stage'],
      ),
      fastingReminderAt: attachedDatabase.typeMapping.read(
        DriftSqlType.dateTime,
...
class RecordRow extends DataClass implements Insertable<RecordRow> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || checkupStage != null) {
      map['checkup_stage'] = Variable<int>(checkupStage);
    }
  ...
  RecordsCompanion toCompanion(bool nullToAbsent) {
    return RecordsCompanion(
      ...
      deletedAt: deletedAt == null && nullToAbsent
          ? const Value.absent()
          : Value(deletedAt),
      checkupStage: checkupStage == null && nullToAbsent
          ? const Value.absent()
          : Value(checkupStage),
  ...
  factory RecordRow.fromJson(
    ...
    return RecordRow(
      ...
      checkupStage: serializer.fromJson<int?>(json['checkupStage']),
  ...
  RecordRow copyWith({
    ...
    checkupStage: checkupStage.present ? checkupStage.value : this.checkupStage,
  ...
  RecordRow copyWithCompanion(RecordsCompanion data) {
    return RecordRow(
      ...
      checkupStage: data.checkupStage.present
          ? data.checkupStage.value
          : this.checkupStage,
...
class RecordsCompanion extends UpdateCompanion<RecordRow> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (checkupStage.present) {
      map['checkup_stage'] = Variable<int>(checkupStage.value);
    }
...
class $VisitQuestionsTable extends VisitQuestions
    with TableInfo<$VisitQuestionsTable, VisitQuestionRow> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ...
  static const VerificationMeta _askedMeta = const VerificationMeta('asked');
  @override
  late final GeneratedColumn<bool> asked = GeneratedColumn<bool>(
    'asked',
    aliasedName,
    false,
    type: DriftSqlType.bool,
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<VisitQuestionRow> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    ...
    if (data.containsKey('asked')) {
      context.handle(
        _askedMeta,
        asked.isAcceptableOrUnknown(data['asked']!, _askedMeta),
      );
    }
    return context;
  }
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  VisitQuestionRow map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return VisitQuestionRow(
      uuid: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}uuid'],
      )!,
      ...
      asked: attachedDatabase.typeMapping.read(
        DriftSqlType.bool,
        data['${effectivePrefix}asked'],
      )!,
    );
  }
...
class VisitQuestionRow extends DataClass
    implements Insertable<VisitQuestionRow> {
  final String uuid;
  ...
  factory VisitQuestionRow.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return VisitQuestionRow(
      ...
      createdAt: serializer.fromJson<DateTime>(json['createdAt']),
      asked: serializer.fromJson<bool>(json['asked']),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'createdAt': serializer.toJson<DateTime>(createdAt),
      'asked': serializer.toJson<bool>(asked),
    };
  }

  VisitQuestionRow copyWith({
    String? uuid,
    int? updatedAtMs,
    Value<int?> syncedAtMs = const Value.absent(),
    int? id,
  ...
  VisitQuestionRow copyWithCompanion(VisitQuestionsCompanion data) {
    return VisitQuestionRow(
      uuid: data.uuid.present ? data.uuid.value : this.uuid,
      updatedAtMs: data.updatedAtMs.present
          ? data.updatedAtMs.value
      ...
      createdAt: data.createdAt.present ? data.createdAt.value : this.createdAt,
      asked: data.asked.present ? data.asked.value : this.asked,
    );
  }

  @override
  String toString() {
    return (StringBuffer('VisitQuestionRow(')
          ..write('uuid: $uuid, ')
          ..write('updatedAtMs: $updatedAtMs, ')
          ..write('syncedAtMs: $syncedAtMs, ')
          ..write('id: $id, ')
  ...
  bool operator ==(Object other) =>
      ...
      (other is VisitQuestionRow &&
          ...
          other.createdAt == this.createdAt &&
          other.asked == this.asked);
}

class VisitQuestionsCompanion extends UpdateCompanion<VisitQuestionRow> {
  final Value<String> uuid;
  final Value<int> updatedAtMs;
  final Value<int?> syncedAtMs;
  final Value<int> id;
  ...
  VisitQuestionsCompanion.insert({
    ...
    this.asked = const Value.absent(),
       ...
       body = Value(body),
       createdAt = Value(createdAt);
  static Insertable<VisitQuestionRow> custom({
    Expression<String>? uuid,
    Expression<int>? updatedAtMs,
    Expression<int>? syncedAtMs,
    Expression<int>? id,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (asked.present) {
      map['asked'] = Variable<bool>(asked.value);
    }
    return map;
  }
...
final class $$PatientsTableReferences
  ...
  static MultiTypedResultKey<$VisitQuestionsTable, List<VisitQuestionRow>>
  _visitQuestionsRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.visitQuestions,
    aliasName: 'patients__id__visit_questions__patient_id',
  );
...
class $$RecordsTableFilterComposer
  ...
  ColumnFilters<int> get checkupStage => $composableBuilder(
    column: $table.checkupStage,
    builder: (column) => ColumnFilters(column),
  );
...
class $$RecordsTableOrderingComposer
  ...
  ColumnOrderings<int> get checkupStage => $composableBuilder(
    column: $table.checkupStage,
    builder: (column) => ColumnOrderings(column),
  );

  ColumnOrderings<DateTime> get fastingReminderAt => $composableBuilder(
    column: $table.fastingReminderAt,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$RecordsTableAnnotationComposer
  ...
  GeneratedColumn<int> get checkupStage => $composableBuilder(
    column: $table.checkupStage,
    builder: (column) => column,
  );
...
final class $$VisitQuestionsTableReferences
    extends
        BaseReferences<_$AppDatabase, $VisitQuestionsTable, VisitQuestionRow> {
  ...
  static $PatientsTable _patientIdTable(_$AppDatabase db) =>
      db.patients.createAlias('visit_questions__patient_id__patients__id');
...
class $$VisitQuestionsTableFilterComposer
  ...
  ColumnFilters<bool> get asked => $composableBuilder(
    column: $table.asked,
    builder: (column) => ColumnFilters(column),
  );
...
class $$VisitQuestionsTableOrderingComposer
  ...
  ColumnOrderings<bool> get asked => $composableBuilder(
    column: $table.asked,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$VisitQuestionsTableAnnotationComposer
  ...
  GeneratedColumn<bool> get asked =>
      $composableBuilder(column: $table.asked, builder: (column) => column);
...
class $$VisitQuestionsTableTableManager
    extends
        RootTableManager<
          ...
          (VisitQuestionRow, $$VisitQuestionsTableReferences),
          VisitQuestionRow,
          PrefetchHooks Function({bool patientId})
        > {
        ...
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                ...
                Value<DateTime> createdAt = const Value.absent(),
                Value<bool> asked = const Value.absent(),
