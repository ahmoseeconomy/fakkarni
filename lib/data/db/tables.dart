...
///
/// **المسح بيمسح**: المحتوى بيتصفّر في لحظته والصف بيختفي من كل قراية.
/// `deletedAt` اللي فاضل هو **شاهدة**، مش مهلة: المزامنة بترفع بس (الدين
/// ١)، فمن غير الشاهدة دي النسخة السحابية تفضل مكانها والابن يفضل شايف
/// حاجة الأب مسحها. المزامنة بتمسحها من السحابة وبعدين بتعلّم الشاهدة.
