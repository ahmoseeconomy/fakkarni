...
/// **لون السجل حسب نوعه — هوية لمجموعة مقفولة، مش تلوين بالدور.**
///
/// `RecordKind` خمس قيم وبس، يعني مجموعة معروفة الحجم — وده بالظبط اللي
/// اللون الفئوي موجود له. **وما بيتوزّعش بالترتيب**: كل نوع له لونه
/// الثابت، فتحليل بيفضل برونزي سواء كان أول مدخل ولا آخر واحد.
/// و«تحاليل» و«زيارات» بياخدوا **نفس لونهم في «متابعة»** — نفس الحاجة
/// في المكانين.
///
/// **وسبعة مداخل أكتر من الألوان اللي عندنا.** المتاح خمسة مش دلالية
/// (الدهبي معناه «محتاجاك» والأحمر للتنبيهات والطوارئ)، والبحث في
/// الجولة اللي فاتت طلّع إن مفيش عايلة ألوان تالتة بتعدّي في الوضعين بعد
/// المحجوزات. فالسجلات بتاخد الهوية، و**اللي مش سجل** — قياسات السكر
/// والأسئلة — بيقعدوا على الرمادي المحايد. ده تقسيم بمعنى، مش نقص لون
/// متغطّى: الاتنين دول صنف تاني خالص عن ورقة في ملف.
Color careRecordAccent(String kind) => switch (kind) {
      'lab' => F.careAccentLab,
      'visit' => F.careAccentVisit,
      'prescription' => F.careAccentTaken,
      'imaging' => F.careAccentUpcoming,
      // حجز ميعاد: مفيش لون سادس، وبياخد المحايد بدل ما ياخد لون
      // معناه حاجة تانية. الدهبي هنا كان هيقول «دي محتاجاك» عن ورقة.
      _ => F.careAccentSkipped,
    };
